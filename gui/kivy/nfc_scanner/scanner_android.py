...
from electrum_zeny_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_zeny.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_zeny"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_zeny:externalType",
                '',
                data)
        return extRecord
